...
//	}
    ...
    public String obtenercontribuyentes(Model modelo){
        logger.info("Verificando ");
        List<ContribuyenteDto> contribuyenteDto = servicioContribuyentes.obtenerContribuyentes();
        
        if(contribuyenteDto.isEmpty()) {
        	modelo.addAttribute("contribuyentes", servicioContribuyentes.obtenerContribuyentes());
